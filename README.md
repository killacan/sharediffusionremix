...
Setting up a new test project for Share Diffusion that would use Remix instead of Next.js. This is a fork of the Remix Starter Kit, which is a Remix + Supabase starter for Typescript lovers. The original README is below.

App is currently very broken and is only going to be a testing ground until it is functional or I understand Remix better.
